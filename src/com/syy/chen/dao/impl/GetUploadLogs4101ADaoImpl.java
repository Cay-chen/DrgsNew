...
import com.syy.chen.dao.GetUploadLogs4101ADao;
...
public class GetUploadLogs4101ADaoImpl implements GetUploadLogs4101ADao {
    @Override
    public WebTableDataBean get4101AUploadLogs(Connection conn, String setlIdMain) throws Exception {
        ...
        String sql ="select * from LOGS_4101A_UPLOAD l where l.SETL_ID_MAIN=? order by l.UPLOAD_DATE desc";
