...
import com.syy.chen.dao.impl.BaoBiao4101ADaoImpl;
...
@WebServlet(name = "BaoBiao4101AServlet", value = "/BaoBiao4101AServlet")
public class BaoBiao4101AServlet extends HttpServlet {
    @Override
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        BaoBiao4101ADaoImpl baoBiaoData = new BaoBiao4101ADaoImpl();
        try {
